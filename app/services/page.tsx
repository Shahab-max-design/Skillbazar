...
function ServicesContent() {
  ...
  const [selectedService, setSelectedService] = useState(serviceParam ? getServiceDisplayName(serviceParam, typeParam as 'digital' | 'onsite' | 'all') : "All Services")
  const [selectedServiceType, setSelectedServiceType] = useState<"onsite" | "digital" | "all">(typeParam as any || "all")
  ...
  }, [selectedArea, selectedService, selectedServiceType, selectedServiceSlug])
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="relative">
              {(() => {
                ...
                let displayServices = ["All Services", "Electrician", "Plumber", "AC Repair", "Carpenter", "Painter", "Appliance Repair"]
                if (selectedServiceType === "digital") {
                  displayServices = digitalServices
                } else if (selectedServiceType === "all") {
                  const onsiteOnly = ["Electrician", "Plumber", "AC Repair", "Carpenter", "Painter", "Appliance Repair"]
